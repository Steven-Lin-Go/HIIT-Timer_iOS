...
const en = {
  ...
  'stats.hrUnavailable': "Apple Health isn't available on this device.",
  'stats.hrDenied': 'Heart-rate access was denied. Enable it in Settings → Health.',
  'stats.hrConnect': 'CONNECT APPLE HEALTH',
  'stats.loading': 'Loading…',
  'stats.hrNoData': 'No heart-rate data for this period.',
  'stats.avgBpm': 'AVG BPM',
  'stats.maxBpm': 'MAX BPM',
...
const zh: Record<StringKey, string> = {
  ...
  'stats.hrUnavailable': '此裝置無法使用 Apple 健康。',
  'stats.hrDenied': '心率存取被拒,請至 設定 → 健康 開啟。',
  'stats.hrConnect': '連接 APPLE 健康',
  'stats.loading': '載入中…',
  'stats.hrNoData': '此期間沒有心率資料。',
  'stats.avgBpm': '平均心率',
  'stats.maxBpm': '最高心率',
